all:
	...
	arch/x86/hw_init.c kernel/display.c
	ld -T kernel/kernel.ld -o kernel.out ks.o kernel.o cpu.o idt.o string.o exception.o pic.o pit.o hw_init.o display.o
	cat boot2.o >> boot1.o
	cat kernel.out >> boot1.o
	mv boot1.o boot.img
	rm -f  boot1.o boot2.o ks.o kernel.o cpu.o idt.o kernel.out \
	string.o pic.o pit.o hw_init.o exception.o display.o
